...
% 读取偏振去歧义后存储的.mat文件
load('/Users/mumu/Documents/MATLAB/Polarizaiton_Imaging_Aid_Coarse_Depth/data_ball/3_rightball_ODS.mat');
normal1 = double(normal1);
[Z_merged1,mask] = mergeDepthNormals(depthmap,normal1,P,k,logical(mask));

load('/Users/mumu/Documents/MATLAB/Polarizaiton_Imaging_Aid_Coarse_Depth/data_ball/3_rightball_PD.mat');
normal1 = double(normal1);
[Z_merged2,mask] = mergeDepthNormals(depthmap,normal1,P,k,logical(mask));

load('/Users/mumu/Documents/MATLAB/Polarizaiton_Imaging_Aid_Coarse_Depth/data_ball/3_rightball_PDS.mat');
normal1 = double(normal1);
