...
if __name__ == '__main__':
    data = sio.loadmat('../data/orthogonal_object_mat/2_penguin.mat')
    ...
    # sio.savemat('../data/orthogonal_object_mat/3_penguin.mat', {'normal1': N_reco_full, 'specmask': new_specmask,
